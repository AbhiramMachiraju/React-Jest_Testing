...
function VShop(props){
  let users = useSelector(state=>state.usersStore.users);
  let numOfLaptops = useSelector(state=>state.laptopsStore.numOfLaptops);
  let numOfMobiles = useSelector(state=>state.mobilesStore.numOfMobiles);
    return (
      <div>
