...
test.skip('TEST_3 :: deleteById API WITHOUT MOCK', async () => {
 ...
 test('TEST_5 :: UPDATE API WITHOUT MOCK', async () => {
    const RequestBody={
        "autoId":13,
...
/*  test('TEST_2 :: getById API WITH MOCK', async () => { 
    axios.get.mockResolvedValue({data: fetchAllData.data[0]});
